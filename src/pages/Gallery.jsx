...
const GALLERY_ITEMS = [
  ...
  { id:1,  src:"/images/gallery/meetup-1.jpg",  caption:"Opening Keynote",          event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:2,  src:"/images/gallery/meetup-2.jpg",  caption:"Networking Session",        event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:3,  src:"/images/gallery/meetup-3.jpg",  caption:"Speaker 1 — Q&A",           event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:4,  src:"/images/gallery/meetup-4.jpg",  caption:"Group Activity",            event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:5,  src:"/images/gallery/meetup-5.jpg",  caption:"Speaker 2 on Stage",        event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:6,  src:"/images/gallery/meetup-6.jpg",  caption:"Group Photo",               event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:7,  src:"/images/gallery/meetup-7.jpg",  caption:"Competition Segment",       event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  { id:8,  src:"/images/gallery/meetup-8.jpg",  caption:"Lunch & Networking",        event:"Developers Meetup 2026",  category:"Meetup",   accent:"#00EEFF" },
  // ── CV to Career Workshop ──
  { id:9,  src:"/images/gallery/workshop-1.jpg", caption:"Session Opening",          event:"CV to Career Workshop",  category:"Workshop", accent:"#4ADE80" },
  { id:10, src:"/images/gallery/workshop-2.jpg", caption:"Live Q&A with Attendees",  event:"CV to Career Workshop",  category:"Workshop", accent:"#4ADE80" },
  { id:11, src:"/images/gallery/workshop-3.jpg", caption:"Blockchain Credentials",   event:"CV to Career Workshop",  category:"Workshop", accent:"#4ADE80" },
  // ── Collaborations ──
  { id:12, src:"/images/gallery/collab-1.jpg",  caption:"LockedIn Community Night",  event:"LockedIn",               category:"Collabs",  accent:"#A78BFA" },
  { id:13, src:"/images/gallery/collab-2.jpg",  caption:"Technical Day 5.0",         event:"Technical Day 5.0",      category:"Collabs",  accent:"#4ADE80" },
  { id:14, src:"/images/gallery/collab-3.jpg",  caption:"AI Fusion 2025",            event:"AI Fusion 2025",         category:"Collabs",  accent:"#FEBC2E" },
  { id:15, src:"/images/gallery/collab-4.jpg",  caption:"Duality Hackathon",         event:"Duality Hackathon",      category:"Collabs",  accent:"#06B6D4" },
  { id:16, src:"/images/gallery/collab-5.jpg",  caption:"DevAI-X Noida",             event:"DevAI-X",                category:"Collabs",  accent:"#A78BFA" },
