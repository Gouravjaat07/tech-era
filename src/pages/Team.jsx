...
//     coLead: { id: "t2", name: "Rewa Gupta", role: "Co-Lead",   initials: "RG", linkedin: "https://www.linkedin.com/in/rewa-gupta-0303b232a?utm_source=share_via&utm_content=profile&utm_medium=member_android", github: "https://github.com/Rewagupta", image: "/images/tech-colead.jpeg", skills: ["Git", "MongoDB", "Full Stack"] },
//     members: [
...
//       { id: "tm3", name: "Shubham",       role: "Frontend",      initials: "SH", linkedin: "https://www.linkedin.com/in/shubham-saini-630502379?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
//     ],
//   },
//   {
...
const GLOBAL_CSS = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media(max-width:479px){
    .founders-grid{padding-left:14px;padding-right:14px}
  }
`;
...
// ════════════════════════════════════════════════════════════
//  FOUNDERS SECTION (Meet The Team — from Home page)
// ════════════════════════════════════════════════════════════
    ...
    >
      ...
      <div className="founder-body">
        ...
        <div className="socials">
          {[
            { href: f.github,    label: "GitHub",    Icon: GHIcon },
            { href: f.linkedin,  label: "LinkedIn",  Icon: LIIcon },
            { href: f.instagram, label: "Instagram", Icon: IGIcon },
          ].map(({ href, label, Icon }) => (
...
function FoundersSection() {
  return (
    <section id="team" style={{ position:"relative", padding:"clamp(56px,9vw,108px) 24px", background:"#050D1A", overflow:"hidden" }}>
      <div style={{ position:"absolute", top:0, left:"50%", transform:"translateX(-50%)", width:"min(800px,90%)", height:1, background:"linear-gradient(90deg,transparent,rgba(0,238,255,.22),transparent)" }} />
      ...
      <div style={{ maxWidth:1152, margin:"0 auto", position:"relative" }}>
        <div style={{ textAlign:"center", marginBottom:"clamp(36px,5vw,60px)" }}>
          <div style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"6px 16px", borderRadius:999, border:"1px solid rgba(79,70,229,.3)", background:"rgba(79,70,229,.1)", marginBottom:16 }}>
            <span className="te-mono" style={{ fontSize:11, fontWeight:700, letterSpacing:".2em", color:"#A78BFA" }}>MEET THE TEAM</span>
          </div>
          <h2 className="te-display" style={{ fontSize:"clamp(26px,4.5vw,50px)", fontWeight:800, color:"white", letterSpacing:"-.03em", marginBottom:12, lineHeight:1.1 }}>
            The People Behind <span className="grad-text">TechEra</span>
          </h2>
          <p style={{ color:"#64748B", fontSize:"clamp(14px,1.8vw,17px)", maxWidth:480, margin:"0 auto", lineHeight:1.7, fontFamily:"'DM Sans',sans-serif" }}>
